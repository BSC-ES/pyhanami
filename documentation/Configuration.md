...
Note that additional fields to check the physical plausibility of the varaible can be added (e.g., max, min, boundaries, ...).



For practical examples of using these configurations, see the [Usage Guide](Usage-Guide.md).
