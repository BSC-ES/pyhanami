...
This page provides the scientific background necessary to understand the evaluations performed by _pyhanami_. It covers key concepts related to ESMs, replicability, and the specific climate phenomena analyzed by the tool.
